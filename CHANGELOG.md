...
- **Advanced Options popup** — moved from collapsible inline panel to a separate window, keeping the main window compact
...
### Changed
- **"Save Settings" buttons renamed** — Search Bar button is now "Save Search" (saves to collection for suites); Advanced Options button is now "Save Defaults" (saves to ~/.docsearchrc)
- **Advanced Options, Search Suites, Index Options** consolidated onto one row
