...
_STRINGS = {
    ...
    "pt-BR": {
        ...
        "step_3_tooltip": "Executar pesquisa padrão — clique para pesquisar todos os arquivos na pasta",
        "step_4_label": " Passo 4 ",
        "step_4_tooltip": "Ver relatório — abra o relatório de resultados destacados. Formatos adicionais (CSV, JSON, PDF, HTML) podem ser habilitados em Opções Avançadas de Pesquisa",
