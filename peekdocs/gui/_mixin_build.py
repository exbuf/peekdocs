...
class BuildMixin:
    ...
    def _show_welcome(self):
        ...
        b("check the ones you want. Search Suites always write TXT and")
        b("DOCX; the format picker in the Suites popup controls HTML /")
        b("CSV / JSON / PDF only. Regex Search always writes TXT and")
        b("DOCX, with no per-format selection. After a Suite or Regex")
        b("run, the Open")
