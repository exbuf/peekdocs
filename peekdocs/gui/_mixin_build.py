...
class BuildMixin:
    def _build_getting_started_tab(self):
        ...
        _step(4, "View your results", "Scan matches in the Results Preview pane, or click DOCX / TXT next to View Report for a highlighted report you can save, print, or share. No Microsoft Word? The DOCX opens in any word processor — LibreOffice (free), Google Docs, or Apple Pages. Prefer your browser? Enable HTML in Advanced Search Options and click the HTML button. The HTML file stays on your computer — nothing is uploaded.")
