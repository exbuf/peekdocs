...
CONFIG_STR_KEYS = {"file_types", "search_terms", "folder", "exclude", "specific_files", "save_name", "append_name", "output_dir", "range", "refresh_interval", "text_size", "preview_size", "assistant_history", "pii_scan_custom_name", "pii_scan_custom_regex", "pii_scan_custom_severity", "pii_scan_custom2_name", "pii_scan_custom2_regex", "pii_scan_custom2_severity"}
