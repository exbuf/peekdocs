...
BANNER_TOP = (
    ...
    '  Source Code:  .asm .bat .c .cpp .cs .css .f .f90 .go .h .hpp .java .js .kt .lua .pl .ps1 .py\n'
    '                .r .rb .rs .s .scala .scss .sh .swift .tcl .ts .vb\n'
    '  Engineering:  .cir .dxf .m .sp .spice .sv .v .vhd .vhdl .vsdx\n'
    '  Data/Config:  .cfg .dockerfile .env .graphql .gql .ini .json .jsonl .log .makefile .ndjson\n'
    '                .proto .sql .tf .toml .txt .xml .yaml .yml\n'
