...
BANNER_TOP = (
    ...
    '  Source Code:  .asm .bat .c .cpp .cs .f .f90 .go .h .hpp .java .js .kt .pl .ps1 .py .r .rb .rs\n'
    '                .s .sh .swift .tcl .ts .vb\n'
...
BANNER_BOTTOM = (
    ...
    '  --open FMT         Automatically open the report when search finishes (docx, txt, csv, json, pdf, html)\n'
    '\n'
...
CONFIG_BOOL_KEYS = {"recursive", "quiet", "match_all", "regex", "ocr", "fuzzy", "wildcard", "whole_word", "index_search", "output_csv", "output_json", "output_pdf", "output_html", "inverse", "timestamp", "hover_text", "pii_scan_custom_enabled", "pii_scan_custom2_enabled"}
