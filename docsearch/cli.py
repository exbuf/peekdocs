...
CONFIG_STR_KEYS = {"file_types", "search_terms", "folder", "exclude", "specific_files", "save_name", "append_name", "output_dir", "suite_output_dir", "range", "refresh_interval", "smtp_host", "smtp_port", "smtp_user", "smtp_password", "email_from", "email_to", "email_on"}
