...
| [API Reference](docs/API.md) | Python library API — `search()` function, parameters, return values. Public surface (`peekdocs.api`) ships type hints verified in CI by mypy on every push. |
