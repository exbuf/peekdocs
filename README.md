...
| [Glossary](docs/GLOSSARY.md) | 92 peekdocs terms: FTS5, regex modes, deterministic, exit codes, Tesseract, jq, SIEM, MSP, network calls, the `peekdocs.errors` exception hierarchy, and more |
