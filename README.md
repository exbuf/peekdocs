...
| **Tesseract** | Free OCR software that reads text from images. Optional — only needed if you want to search scanned documents or photos of text. Originally developed at Hewlett-Packard in the 1980s, later acquired and open-sourced by Google in 2006. Now the most widely used open-source OCR engine in the world. Version 4+ includes a built-in LSTM neural network for improved accuracy. (The name comes from mathematics — a tesseract is a 4-dimensional cube.) |
