...
> peekdocs is a desktop application that runs on your local computer — not a browser app, not a cloud service. It searches your Word docs, PDFs, spreadsheets, emails, and 46 file types in all — at once, all offline. Type a word, click a button, see your results. No manual needed.
