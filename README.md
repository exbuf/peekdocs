...
- **Home users** — almost everyone has tax returns, medical records, insurance policies, or a laptop they may sell someday at home. Once installed, type your keyword(s), click Run Search, done. No configuration, no manual. Click **PII Scan** to check your files for Social Security numbers, credit cards, and other sensitive data — one click, no setup
