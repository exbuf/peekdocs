...
| **Tesseract** | Free OCR software that reads text from images. Optional — only needed if you want to search scanned documents or photos of text. (The name comes from mathematics — a tesseract is a 4-dimensional cube.) |
