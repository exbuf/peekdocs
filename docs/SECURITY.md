...
- **Free under MIT — no paid tier.** peekdocs doesn't offer paid support, custom builds, NDA-bound consulting, or compliance-attestation artifacts (SOC 2 reports, ISO 27001 certifications, signed SBOMs, etc.). Organizations whose vendor-management process needs those artifacts are welcome to evaluate peekdocs against their internal risk-acceptance framework instead.
