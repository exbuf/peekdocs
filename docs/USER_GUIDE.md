...
| **Toolbar** | **User Guide**, **View All peekdocs Files**, **All Collections** (global view of saved searches across all folders), **Error Log**, **Maintenance**, **Text Size**, **Disable Hover Text** (tooltips are on by default), and **About** buttons |
